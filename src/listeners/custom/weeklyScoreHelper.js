...
const TRIGGERS = [
  ...
  /how.*participate/i,
  /how (do i|can i|do you).*(join|start|begin|enter|participate)/i,
  /\bjoin\b.*\?/i,
  /how.*(get in|sign up|sign-up)/i,
  /find.*(instructions|info|tutorial|guide|how to)/i,
  /where.*(instructions|info|tutorial|guide|start)/i,
  /can'?t (find|figure out|see).*(how|instructions|join|start)/i,
  /tutorial.*competi/i,
